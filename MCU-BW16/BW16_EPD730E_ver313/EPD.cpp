...
void EPD::EPD_7IN3F_Show7Block(void)
{
    ...
    {EPD_7IN3E_BLACK, EPD_7IN3E_RED, EPD_7IN3E_GREEN, EPD_7IN3E_BLUE,
    EPD_7IN3E_YELLOW, EPD_7IN3E_BLACK, EPD_7IN3E_RED, EPD_7IN3E_GREEN};
    SPI_Begin();
    SendCommand(0x10);
    for(i=0; i<240; i++) {
        for(k = 0 ; k < 4; k ++) {
