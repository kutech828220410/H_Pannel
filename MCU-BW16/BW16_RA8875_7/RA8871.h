...
#define RA8875_DATAWRITE 0x80 ///< See datasheet
#define RA8875_DATAREAD 0xC0  ///< See datasheet
#define RA8875_CMDWRITE 0x00  ///< See datasheet
#define RA8875_CMDREAD 0x40   ///< See datasheet
...
class RA8875
{
   ...
   void PLL_init();
   void ActiveWindow(uint16_t XL ,uint16_t XR ,uint16_t YT ,uint16_t YB);
