...
//OLED的初始化
void OLED114::Lcd_Init(DFRobot_MCP23017& mcp)
{ 
    _mcp = &mcp;
   
    pinMode(dc,OUTPUT);//设置数字11
    pinMode(cs,OUTPUT);//设置数字12 
//    mcp.digitalWrite(/*pin = */mcp.eGPB7, false);
//    delay(100);
//    mcp.digitalWrite(/*pin = */mcp.eGPB7, true);
//    delay(200);
//    mcp.digitalWrite(/*pin = */mcp.eGPB7, false);
//    delay(100);
    LCD_WR_REG(0x11); 
    delay(300);
    OLED_CS_Clr();  
    _mcp ->digitalWrite(/*pin = */_mcp -> eGPB, /*Port Value = */0x00);
    delay(300);
...
void OLED114::OLED_CS_Clr()
{
  ...
  _mcp ->digitalWrite(_mcp ->eGPB7 , !(index == 7));
