...
void serialEvent()
{
  ...
  if (MyTimer_UART0.IsTimeOut())
  {
    ...
    if (UART0_RX[0] == '1'&& UART0_len == 3)
    {
      mySerial.print("EPD imgageData1 refresh..\n ");
      epd.RW_Command();
    ...
    if (UART0_RX[0] == '2'&& UART0_len == 3)
    {
      mySerial.print("EPD imgageData2 refresh..\n ");
      epd.RW_Command();
    ...
    if (UART0_RX[0] == '3'&& UART0_len == 3)
    {
      mySerial.print("EPD imgageData3 refresh..\n ");
      epd.RW_Command();
    ...
    if (UART0_RX[0] == '4'&& UART0_len == 3)
    {
      mySerial.print("EPD imgageData4 refresh..\n ");
      epd.RW_Command();
    ...
    if (UART0_RX[0] == '5'&& UART0_len == 3)
    {
      mySerial.print("EPD imgageData5 refresh..\n ");
      epd.RW_Command();
    ...
    if (UART0_RX[0] == '6'&& UART0_len == 3)
    {
      mySerial.print("EPD imgageData6 refresh..\n ");
      epd.RW_Command();
