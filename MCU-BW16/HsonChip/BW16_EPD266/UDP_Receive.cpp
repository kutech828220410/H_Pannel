...
void onPacketCallBack()
{
  ...
  if(!flag_UDP_RX_BUFFER_Init)
  {
     ...
     mySerial.print("UdpRead malloc : ");
     mySerial.print(UDP_BUFFER_SIZE);
     mySerial.println(" bytes");
     UdpRead = (char*) malloc(UDP_BUFFER_SIZE);
     mySerial.println("UdpRead malloc done... ");

     mySerial.print("Free heap: ");
     mySerial.println(xPortGetFreeHeapSize());    
     mySerial.print("UdpRead_buf malloc : ");
     mySerial.print(UDP_RX_BUFFER_SIZE);
     mySerial.println(" bytes");
     UdpRead_buf = (char*) malloc(UDP_RX_BUFFER_SIZE);
     mySerial.println("UdpRead_buf malloc done... ");
