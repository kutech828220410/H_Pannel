...
namespace H_Pannel_lib
{
    public partial class EPD360E_Paint_Form : MyDialog
    {
        ...
        public EPD360E_Paint_Form(Storage _storage)
        {
            InitializeComponent();
            ...
            this.ShowDialogEvent += EPD360E_Paint_Form_ShowDialogEvent;
            this.LoadFinishedEvent += EPD360E_Paint_Form_LoadFinishedEvent;

            this.rJ_Button_確定.MouseDownEvent += RJ_Button_確定_MouseDownEvent;
            this.rJ_Button_取消.MouseDownEvent += RJ_Button_取消_MouseDownEvent;
        }

        private void EPD360E_Paint_Form_ShowDialogEvent()
        {

        }
        private void EPD360E_Paint_Form_LoadFinishedEvent(EventArgs e)
        {
            DrawToPictureBox(CurrentStorage);

            this.PanelSelectEvent += EPD360E_Paint_Form_PanelSelectEvent;
        ...
        private void EPD360E_Paint_Form_PanelSelectEvent(Device.ValueName valueName)
        {
        ...
        private void PictureBox_paint_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            double X = e.X / this.CanvasScale;
            double Y = e.Y / this.CanvasScale;
            ...
            if (this.flag_pictureBox_mouseDown)
            {
                int move_X = (int)(X - this.pictureBox_mouseDown_X);
                int move_Y = (int)(Y - this.pictureBox_mouseDown_Y);
        ...
        private void PictureBox_paint_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            for (int i = 0; i < valueNames.Length; i++)
            {
                ...
                if (this.MouseDownType != TxMouseDownType.NONE)
                {
                    ...
                    this.pictureBox_mouseDown_X = (int)X;
                    this.pictureBox_mouseDown_Y = (int)Y;
        ...
        {
            Dialog_6Color_select Dialog_6Color_select = new Dialog_6Color_select(this.rJ_Pannel_文字背景顏色.BackgroundColor);
            if (Dialog_6Color_select.ShowDialog() != DialogResult.Yes) return;
            this.rJ_Pannel_文字背景顏色.BackgroundColor = Dialog_6Color_select.Value;
        ...
        {
            Dialog_6Color_select Dialog_6Color_select = new Dialog_6Color_select(this.rJ_Pannel_字體顏色.BackgroundColor);
            if (Dialog_6Color_select.ShowDialog() != DialogResult.Yes) return;
            this.rJ_Pannel_字體顏色.BackgroundColor = Dialog_6Color_select.Value;
        ...
        {
            Dialog_6Color_select Dialog_6Color_select = new Dialog_6Color_select(this.rJ_Pannel_邊框顏色.BackgroundColor);
            if (Dialog_6Color_select.ShowDialog() != DialogResult.Yes) return;
            this.rJ_Pannel_邊框顏色.BackgroundColor = Dialog_6Color_select.Value;
        ...
        {
            Dialog_6Color_select Dialog_6Color_select = new Dialog_6Color_select(this.rJ_Pannel_背景顏色.BackgroundColor);
            if (Dialog_6Color_select.ShowDialog() != DialogResult.Yes) return;
            this.rJ_Pannel_背景顏色.BackgroundColor = Dialog_6Color_select.Value;
        ...
        private void TextBox_邊框大小_Click(object sender, EventArgs e)
        {
            ...
            Storage.ValueName valueName = (GetSelectValueName());
            CurrentStorage.SetValue(valueName, Device.ValueType.BorderSize, (int)dialog_NumPannel.Value);
            this.DrawToPictureBox();
        }
