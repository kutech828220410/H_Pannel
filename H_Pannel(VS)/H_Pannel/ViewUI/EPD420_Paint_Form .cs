...
{
    public partial class EPD420_Paint_Form : MyDialog
    {
        ...
        private double CanvasScale = 1.5;
        ...
        public EPD420_Paint_Form(Storage _storage)
        {
            InitializeComponent();
            ...
            this.ShowDialogEvent += EPD420_Paint_Form_ShowDialogEvent;
            this.LoadFinishedEvent += EPD420_Paint_Form_LoadFinishedEvent;

            this.rJ_Button_確定.MouseDownEvent += RJ_Button_確定_MouseDownEvent;
            this.rJ_Button_取消.MouseDownEvent += RJ_Button_取消_MouseDownEvent;
        }

        private void EPD420_Paint_Form_ShowDialogEvent()
        {

        }
        private void EPD420_Paint_Form_LoadFinishedEvent(EventArgs e)
        {
            DrawToPictureBox(CurrentStorage);

            this.PanelSelectEvent += EPD420_Paint_Form_PanelSelectEvent;
