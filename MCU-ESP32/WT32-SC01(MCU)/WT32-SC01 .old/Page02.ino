...
void Button_Page02_SSID_PressDown()
{
  while(true)
  {
    ...
    if(_KeyBoardABC.Show(tft , touchPos) == 1)break;
  }
  Screen_Page02_Init = true;

  String str_SSID = _KeyBoardABC.TEXT;
  String str = "SSID : " + _KeyBoardABC.TEXT;
...
void Button_Page02_Password_PressDown()
{
  ...
  String str_Password = _KeyBoardABC.TEXT;
...
void Button_Page02_ServerPort_PressDown()
{
  ...
  String Str_Port = _KeyBoardABC.TEXT;
